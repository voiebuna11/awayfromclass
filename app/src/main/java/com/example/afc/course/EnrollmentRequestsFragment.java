...
public class EnrollmentRequestsFragment extends BaseFragment {
    ...
    public EnrollmentRequestsFragment(String course_id){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.course_enrollment_list);
        mUserListEmpty = (TextView) view.findViewById(R.id.course_enrollment_empty);
        mRecyclerView.setHasFixedSize(true);

        mLayoutManager = new LinearLayoutManager(getActivity(), RecyclerView.VERTICAL, false);
        mRecyclerView.setLayoutManager(mLayoutManager);
        mAdapter = new RecyclerCourseEnrollmentReqAdapter(getActivity(), mUserList, mCourseId);
    ...
    private void jsonParseUserList() {
        mUserList.clear();
        String url = session.getAFCLink() + "/afc/courses/get_course_enrollments.php";
